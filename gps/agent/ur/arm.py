...
from gps.agent.ur.constants import JOINT_ORDER, JOINT_PUBLISHER_REAL, JOINT_PUBLISHER_SIM, FT_SUBSCRIBER_REAL, FT_SUBSCRIBER_SIM
...
class Arm(object):
    ...
    def __init__(self, ft_sensor=False, real_robot=False, ee_transform=[0, 0, 0, 0, 0, 0, 1], robot_urdf='ur3_robot'):
        """ Constructor 
