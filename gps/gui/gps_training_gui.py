...
class GPSTrainingGUI(object):
    ...
    def __init__(self, hyperparams):
        ...
        self._gs = gridspec.GridSpec(16, 10)
        # self._gs_action_panel           = self._gs[0:2,  0:8]
        # self._gs_action_output          = self._gs[0:3,  0:4]
        self._gs_status_output          = self._gs[0:1,  0:10]
        self._gs_cost_plotter           = self._gs[1:4,  1:9]
        self._gs_algthm_output          = self._gs[5:8,  0:10]
        if config['image_on']:
            self._gs_traj_visualizer    = self._gs[8:16, 0:5]
            self._gs_image_visualizer   = self._gs[8:16, 5:10]
        else:
            self._gs_traj_visualizer    = self._gs[8:16, 0:10]
